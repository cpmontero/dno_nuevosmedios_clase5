...
*/
Papa.parse("https://raw.githubusercontent.com/cpmontero/dno_nuevosmedios_clase5/main/indice-uso-cobre.csv", {
    download: true,
    header: true,
    dynamicTyping: true,
                ...
                new Chart(document.querySelector("#grafico").getContext("2d"), {
                    ...
                    data: {
                        ...
                        datasets: [
                            {
                                data: indice,
                                backgroundColor: "rgba(203, 232, 238, 0.5)",
                                borderColor: "rgba(11, 107, 102, .5)",
                                pointRadius: 5,
                                borderWidth: 3,
                                lineTension: 0.2,
                            },
